    ...
    <div class="row g-gs">
        <div class="card-inner">
            <div class="align-center flex-wrap g-4 text-center">
                <div class="nk-block-image w-120px flex-shrink-0 mx-auto"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 118">
                ...
                <div class="nk-block-content">
                    <div class="nk-block-content-head">
                        <h5>ส่งคำตอบเรียบร้อย !</h5>
                        <p class="text-soft">ส่งคำตอบไปยังผู้ดูแลระบบเรียบร้อย กรุณารอแอดมินหรือผู้แลระบบตรวจคำตอบ</p>
                    </div>
                </div>
                <div class="nk-block-content flex-shrink-0 mt-lg-4 mx-auto">
                    <a href="{{ route('home') }}" class="btn btn-lg btn-outline-primary">กลับสู่หน้าแรก</a>
                </div>
            </div>
        </div>
    </div>
